  ...
  return (
    <div className={`bg-transparent w-full max-w-2xl z-10 rounded-lg border-2 border-solid border-opacity-30 border-secondary shadow-md ${className}`}>
      <div className="m-4">
        ...
        me with a variety of unconventional experiences and opportunities. I have done everything from starting and operating a vertically
        ...
        As a self-taught &quot;outsider&quot; to the industry there has been no clear path or straightforward opportunity brought to me. These are
