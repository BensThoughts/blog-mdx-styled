...
2) utilizes the latest in Typescript, React, Next.js, and @emotion/styled to
create a solution that includes full type safety and the latest APIs.  It is
fast, and runs buttery smooth"
date: "2021-08-29"
readTime: 30
