---
title: "Beautiful Links With CSS"
description: "In this article I show you how I built a stylish and reusable link
component that works with the Next.js Link component.  The component is also fully typed with Typescript."
date: "2021-09-21"
modifiedDate: "2021-09-21"
readTime: 15
imgPathTiny: "https://res.cloudinary.com/bensthoughts/image/upload/q_10/v1632290818/blog/articles/beautiful-typed-links/fahrul-azmi-BnWDqUCWQDU-unsplash_jjx1yv.jpg"
imgPathLarge: "https://res.cloudinary.com/bensthoughts/image/upload/q_auto/v1632290818/blog/articles/beautiful-typed-links/fahrul-azmi-BnWDqUCWQDU-unsplash_jjx1yv.jpg"
imgWidth: 1200
imgHeight: 960
imgAlt: "Highway Ramps"
ogTitle: "Building a Stylish Link Component"
ogDescription: "A simple but reusable link component"
ogImageUrl: "https://res.cloudinary.com/bensthoughts/image/upload/q_auto/v1632290818/blog/articles/beautiful-typed-links/fahrul-azmi-BnWDqUCWQDU-unsplash_jjx1yv.jpg"
ogImageWidth: 1200
ogImageHeight: 960
ogImageAlt: "Highway Ramps"
tags:
  - 'typescript'
  - 'react'
  - '@emotion'
...
start a Next.JS project can be found here [next.js](https://nextjs.org/docs)

Install [@emotion/styled](https://emotion.sh/docs/install)
...
```jsx:/components/AnimatedLink/index.tsx
...
I have joined the base typings of the component with React.AnchorHTMLAttributes<HTMLAnchorElement/> using a Typescript intersection (the
&). This is what allows any user of the component to pass any valid anchor props to
the component. I use {..rest} to spread those props out within the styled anchor
element itself. In total this makes the component highly reusable because any user of
the component can attach any valid anchor element props (such as style={{}}, rel="",
or the all important href="") to the component for a given use case.
